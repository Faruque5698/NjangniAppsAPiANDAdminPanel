                    ...
                    <table class="table">
                        ...
                        @foreach($groups as $group)
                            <tr>
                                ...
                                <td>{{$group->contributional_interval}}</td>
...
{{--                                    @endif--}}
                                    ...
                                    <a href="{{route('invest_group_members_list',['id'=>$group->id])}}" class="btn btn-sm btn-success"><i class="fa fa-info-circle"></i></a>

{{--                                    <a href="{{route('invest_member_delete',['id'=>$group->id])}}" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></a>--}}
                                </td>
